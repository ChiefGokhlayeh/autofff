...
CLANG_SCANNER_SECTION = 'clang.scanner'

CLANG_SCANNER_LIBCLANG_PATH = 'libclang_path'
CLANG_SCANNER_LIBCLANG_PATH_DEF = '/usr/lib/llvm-8/lib'

CLANG_SCANNER_LIBCLANG_FILE = 'libclang_file'
CLANG_SCANNER_LIBCLANG_FILE_DEF = '/usr/lib/llvm-8/lib/libclang-8.so'
...
CONFIG_SPEC = [
    ...
    f"[[{CLANG_SCANNER_SECTION}]]",
    f"{CLANG_SCANNER_LIBCLANG_PATH} = string(default='{CLANG_SCANNER_LIBCLANG_PATH_DEF}')",
    f"{CLANG_SCANNER_LIBCLANG_FILE} = string(default='{CLANG_SCANNER_LIBCLANG_FILE_DEF}')",
